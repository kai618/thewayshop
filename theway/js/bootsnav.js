    ...
    var bootsnav = {
        ...
        event: function() {
            ...
            if (getNav.hasClass("navbar-full")) {
                ...
                $("ul.nav.navbar-nav")
                    .prepend("<li class='close-full-menu'><a href='#'><i class='fa fa-times'></i></a></li>");
